...
import { dataModelManager } from '@shuttle-data/type'
...
class RenderFieldPluginManager {
  private plugins: Record<
    DataModel.FieldType,
    DataModel.Render.FieldPlugin<any>
  > = {
  ...
  use(plugin: DataModel.Render.FieldPlugin<DataModel.FieldType>) {
...
export default new RenderFieldPluginManager()
